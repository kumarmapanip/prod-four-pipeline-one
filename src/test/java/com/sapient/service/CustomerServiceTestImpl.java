...
class CustomerServiceTestImpl {
	...
	public void dummyManagement() {
			...
			Customer cust1 = new Customer(1211,"Alfred Novel",7898989890L,216,LocalDate.of(1999, 1, 9),"Vyasanagar");
			Customer cust2 = new Customer(4007,"Anne Hathaway",7966478895L,210,LocalDate.of(1998, 11, 8),"Shimla");
			Customer cust3 =						
					new Customer(2164,"August Kennedy",9877895632L,272,LocalDate.of(2004, 4, 5),"Ranital");
	...
	public void validNameFromId() {
		...
		try {
			...
			assertThat(testCust.getAddress()=="Shimla");
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
